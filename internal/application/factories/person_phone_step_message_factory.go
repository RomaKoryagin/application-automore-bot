...
func (factory PersonPhoneStepMessageFactory) CreateMessage(chatId int64) *tgbotapi.MessageConfig {
	msg := tgbotapi.NewMessage(chatId, "Пожалуйста, укажите Ваш номер телефона в формате 7ХХХХХХХХХХ ⚠️Номер нужен для авторизации, проверка защиты от ботов, благодарим за понимание.")
